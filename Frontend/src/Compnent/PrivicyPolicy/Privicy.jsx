  ...
  return (
    <>
      <div
        ...
        // style={{
        //   background:
        //     "url('https://www.livlightweightloss.com/wp-content/uploads/2018/09/Weight-Loss-Center-Privicy-Policy.jpg')no-repeat center center/contain",

        // }}
      >
        <h1 className="md:text-[65px] text-center text-[45px] text-[white] font-bold">
          Privacy & Policy
        </h1>
      </div>
        ...
        <p className="mb-4">
          ...
          <ul className="list-disc list-inside mb-4">
            ...
            <li>
              ...
              you, please write to PostoCARD.com
            </li>
            <li>
